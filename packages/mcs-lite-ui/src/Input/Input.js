...
const Input = styled.input`
  ...
  border-color: ${props => (props.focus ? props.theme.color[props.kind] : props.theme.color.grayDark)};
  box-shadow: ${props => (props.focus ? `0 0 3px 0 ${shadow(props.theme.color[props.kind])}` : 'none')};
